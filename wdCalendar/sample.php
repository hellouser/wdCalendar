           ...
           var view="week";          
            ...
            function cal_beforerequest(type)
            {
                ...
                switch(type)
                {
                    ...
                    case 3:  
                    case 4:    
                        t="La demande est en cours de traitement...";                                   
                        break;
                }
                $("#errorpannel").hide();
            ...
            function Edit(data)
            {
               var eurl="edit.php?id={0}&start={2}&end={3}&isallday={4}&title={1}";   
                if(data)
                {
                    ...
                    OpenModelWindow(url,{ width: 600, height: 400, caption:"Modifier l'évènement",onclose:function(){
            ...
            function View(data)
            {
                ...
                $.each(data, function(i, item){
                    if(i == 1)
						...
						date_deb_fin += "- Date de début :\n > > > > " + item.toLocaleString() + "\n";		
					else if(i == 3)
						date_deb_fin += "- Date de fin :\n > > > > " + item.toLocaleString() + "\n";	
					else if(i == 4)
					{
						if(item == 1)
							journee_totale = true ;
            ...
            {           
                ...
                hiConfirm("Voulez vous vraiment supprimer cet évènement ?", 'Confirmation',function(r){ r && callback(0);});           
            }
            function wtd(p)
            {
               if (p && p.datestrshow) {
            ...
            $("#faddbtn").click(function(e) {
                var url ="edit.php";
                OpenModelWindow(url,{ width: 500, height: 400, caption: "Créer un nouvel évènement"});
            });
            //go to today
            ...
            $("#test").click(function(e) {
                var p = $("#gridcontainer").swtichView("week");
            });
        });
    </script>    
</head>
    ...
    <div>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            ...
            <div id="loadingpannel" class="ptogtitle loadicon" style="display: none;">Chargement des données...</div>
             <div id="errorpannel" class="ptogtitle loaderror" style="display: none;">Pardon, les données ne peuvent pas être chargées, merci d'essayer plus tard</div>
            </div>          
            ...
            <div class="btnseparator"></div>
             <div id="showtodaybtn" class="fbutton">
                ...
                Aujourdhuit</span></div>
            </div>
              <div class="btnseparator"></div>

            <div id="showdaybtn" class="fbutton">
                <div><span title='Day' class="showdayview">Journée</span></div>
            </div>
